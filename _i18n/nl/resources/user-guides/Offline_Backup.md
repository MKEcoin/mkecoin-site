...
### MKEcoin-binaries downloaden:  [Binaire bestanden voor MKEcoin]({{ site.baseurl }}/downloads/)
...
- Maak een opstartbare schijf voor Linux of Windows, en zet de MKEcoin-binaries op dezelfde schijf of een tweede schrijf. (Maak voor Linux ook kopieën van de gedownloade afhankelijkheden die je nodig hebt, bijvoorbeeld libboost1.55 en miniupnpc.)
...
- Kopieer de MKEcoin-binaries naar een RAM-schijf (/dev/shm in Linux, in Windows meestal een station Z: of zoiets op een opstartbare ISO).

- Voer de MKEcoin-daemon niet uit. Gebruik in plaats daarvan MKEcoin-wallet-cli in een opdrachtregelvenster om een nieuw MKEcoin-@account aan te maken.
...
Gerelateerd:  [Offline account-generator](http://MKEcoinaddress.org/)
