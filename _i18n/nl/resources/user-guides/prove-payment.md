...
MKEcoin is echter vertrouwelijk, dus die informatie is niet openbaar beschikbaar op de blockchain. Er zijn dus iets meer
stappen nodig.
...
- de transactiesleutel, een nieuwe uitvinding bij MKEcoin en andere Cryptonote-coins

Toen Alice de transactie uitvoerde, is er automatisch een sleutel speciaal voor deze transactie gegenereerd.

#### Opdrachtregel

Alice kan deze sleutel als volgt opvragen in MKEcoin-wallet-cli (voorheen simplewallet):
...
Dit werkt alleen als MKEcoin-wallet-cli is ingesteld op het bewaren van transactiesleutels. Controleer dit als volgt:
...
Alice kan haar MKEcoin-wallet-gui openen en haar transactiedetails bekijken op de pagina Geschiedenis:
...
Charlie typt het volgende in MKEcoin-wallet-cli:

> check_tx_key TXID SLEUTEL ADRES

Daarbij vult hij de door Alice verstrekte gegevens in plaats van de variabelen in. MKEcoin-wallet-cli gebruikt de transactiesleutel
...
Charlie opent MKEcoin-wallet-gui en gaat naar de pagina Geavanceerd > Bewijzen/controleren om de gegevens van Alice in te vullen in het gedeelte Transactie controleren.
