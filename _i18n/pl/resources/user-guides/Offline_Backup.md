...
#### Materiały do plików binarnych MKEcoin:  [Pliki Binarne MKEcoin]({{ site.baseurl }}/downloads/)
...
- Stwórz dysk rozruchowy Linux lub Windows i upewnij się, że twoje pliki binarne MKEcoin znajdują się na tym samym dysku lub na drugim dysku (w przypadku Linuxa, upewnij się, że ściągnąłeś także kopie zależności, których będziesz potrzebował, np. libboost1.55 i miniupnpc).
...
- Skopiuj pliki binarne MKEcoin na dysk RAM (/dev/shm w Linuxie, pliki binarne Windowsa normalnie mają dysk Z: lub coś w tym stylu).

- Nie uruchamiaj daemona MKEcoin. Zamiast tego, za pomocą polecenia wiersza, użyj funkcji MKEcoin-wallet-cli, żeby stworzyć nowe konto MKEcoin.
...
Powiązane:  [Generator Konta Offline](http://MKEcoinaddress.org/)
